  ...
  return (
    <header
      className={`header left-0 top-0 z-40 flex w-full items-center ${
        sticky
          ? `dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] ${isMobile ? 'bg-gradient' : 'glassmorphism'} !bg-opacity-80 shadow-sticky backdrop-blur-sm transition`
      ...
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-60 max-w-full px-4 xl:mr-12">
            <Link to="/" className={`header-logo block w-full ${sticky ? 'py-5 lg:py-2' : 'py-5'}`}>
              {renderLogo()}
            </Link>
          </div>
